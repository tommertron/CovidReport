...
class TestOntarioDataSource(unittest.TestCase):
    def test_query_vaccinedata(self):
        ...
        mock_method.assert_called_with(datetime.date(2022, 1, 12), 'VaccineData', ['total_doses_administered', 'total_individuals_at_least_one', 'total_individuals_fully_vaccinated', 'total_individuals_3doses'])
